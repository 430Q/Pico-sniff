...
class IP(object):
    ...
    def get_Info(self):
        ...
        info['IPv4_protocol'] = '[8 bit]' + str(self.PROTOCOL) # 判斷什麽協議
    ...
    def get_threatInfo(self):
        TInfo={}
        TInfo['IPv4_protocol'] = str(self.PROTOCOL)
        TInfo['SRC_IPv4'] = str(self.SRC_IP4)
        TInfo['DEST_IPv4'] = str(self.DEST_IP4)
        return(TInfo,'IP')
